...
const child=spawn(ffmpeg,['-y','-f','image2pipe','-vcodec','png','-r','24','-i','-','-an','-c:v','libx264','-preset','fast','-crf','21','-pix_fmt','yuv420p','-movflags','+faststart','exports/stylized-study.mp4'],{stdio:['pipe','ignore','inherit']});
